 ...
 * {@link org.eclipse.paho.client.util.Debug Debug} provides method to make it easy
...
public class JSR47Logger implements Logger {
	 ...
	 * @param loggerID			The suffix for the loggerName (will be appeneded to org.eclipse.paho.client
...
//		loggerName = "org.eclipse.paho.client." + ((null == loggerID || 0 == loggerID.length()) ? "internal" : loggerID);
		loggerName = loggerID;
